...
export function SureThemeSettings() {
  const {
    register,
    formState: { errors },
  ...
  return (
    <>
      ...
      >
        <Input
          {...register("site.theme.sure.navBarName")}
      ...
      <AssetUploadField
        name="site.theme.sure.background.homeImage"
        assetPath="themes/sure/home-image.webp"
        accept=".png,.webp,.jpg,.jpeg"
        label={m.settings_site_field_home_image()}
        hint={m.settings_site_field_home_image_hint()}
        placeholder="/images/asset/themes/sure/home-image.webp or https://picsum.photos/1600/900"
        error={errors.site?.theme?.default?.background?.homeImage?.message}
      />
      <AssetUploadField
        name="site.theme.sure.background.globalImage"
        assetPath="themes/sure/global-image.webp"
        accept=".png,.webp,.jpg,.jpeg"
        label={m.settings_site_field_global_image()}
        hint={m.settings_site_field_global_image_hint()}
        placeholder="/images/asset/themes/sure/global-image.webp or https://picsum.photos/1600/900"
        error={errors.site?.theme?.default?.background?.globalImage?.message}
      />
      <RangeField
        name="site.theme.sure.background.light.opacity"
      ...
      />
      <RangeField
        name="site.theme.sure.background.dark.opacity"
      ...
      />
      <RangeField
        name="site.theme.sure.background.backdropBlur"
      ...
      />
      <RangeField
        name="site.theme.sure.background.transitionDuration"
