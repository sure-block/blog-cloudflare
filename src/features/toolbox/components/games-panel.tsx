...
const Game2048 = lazy(() => import("./apps/games/Game2048"));
const SnakeGame = lazy(() => import("./apps/games/SnakeGame"));
const MinesweeperGame = lazy(() => import("./apps/games/MinesweeperGame"));
const TetrisGame = lazy(() => import("./apps/games/TetrisGame"));
const FlappyBirdGame = lazy(() => import("./apps/games/FlappyBirdGame"));
const MemoryGame = lazy(() => import("./apps/games/MemoryGame"));
const BreakoutGame = lazy(() => import("./apps/games/BreakoutGame"));
const ShooterGame = lazy(() => import("./apps/games/ShooterGame"));
const GomokuGame = lazy(() => import("./apps/games/GomokuGame"));
const WatermelonGame = lazy(() => import("./apps/games/WatermelonGame"));
const BlackjackGame = lazy(() => import("./apps/games/BlackjackGame"));
const CoinCatcherGame = lazy(() => import("./apps/games/CoinCatcherGame"));
const SudokuGame = lazy(() => import("./apps/games/SudokuGame"));
const Match3Game = lazy(() => import("./apps/games/Match3Game"));
const WhackAMoleGame = lazy(() => import("./apps/games/WhackAMoleGame"));
const StackGame = lazy(() => import("./apps/games/StackGame"));
const ColorSwitchGame = lazy(() => import("./apps/games/ColorSwitchGame"));
const DoodleJumpGame = lazy(() => import("./apps/games/DoodleJumpGame"));
  ...
  },
  {
    ...
    icon: (
      <svg className="w-12 h-12" viewBox="0 0 48 48" fill="none">
        ...
        />
        <path
          d="M14 28c0-2 2-4 4-4h4c2 0 4-2 4-4s2-4 4-4"
          stroke="#10b981"
          strokeWidth="2.5"
          strokeLinecap="round"
        />
    ...
    icon: (
      <svg className="w-12 h-12" viewBox="0 0 48 48" fill="none">
        ...
        <line
          ...
          opacity="0.5"
        />
        <text x="14" y="17" fontSize="7" fill="#6366f1">
          5
        </text>
        <text x="25" y="27" fontSize="7" fill="#6366f1">
          9
        </text>
        <text x="34" y="17" fontSize="7" fill="#6366f1">
          1
        </text>
        <text x="14" y="37" fontSize="7" fill="#6366f1">
          3
        </text>
      </svg>
    ),
        ...
        >
          ...
          <div className="flex-1 overflow-auto overscroll-contain p-4 flex flex-col">
            {activeGame && currentGame ? (
              <Suspense
                fallback={
                  <div className="flex items-center justify-center h-64 text-sm text-slate-400 animate-pulse">
                    加载中...
                  </div>
                }
              >
