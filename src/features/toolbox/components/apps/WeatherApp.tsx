...
interface WeatherData {
  ...
  life_indices?: Record<
    string,
    { level: string; brief: string; advice: string }
  >;
}
...
function WeatherIcon({ code, size = 40 }: { code: string; size?: number }) {
    ...
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        ...
        <g stroke="#FBBF24" strokeWidth="2.5" strokeLinecap="round">
          ...
          <line x1="33.9" y1="33.9" x2="37.4" y2="37.4" />
          <line x1="10.6" y1="37.4" x2="14.1" y2="33.9" />
          <line x1="33.9" y1="14.1" x2="37.4" y2="10.6" />
        </g>
      </svg>
    );
  // Partly cloudy
  if (["101", "102", "103"].includes(code))
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        ...
        <path
          d="M16 34a8 8 0 01-2-15.8A10 10 0 0133.5 22 7 7 0 0136 34H16z"
          fill="#E2E8F0"
        />
      </svg>
    );
  ...
  if (code === "104")
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        <path
          d="M12 34a8 8 0 01-2-15.8A10 10 0 0129.5 22 7 7 0 0132 34H12z"
          fill="#94A3B8"
        />
        <path
          d="M22 28a6 6 0 01-1.5-11.8A8 8 0 0135 19a5.5 5.5 0 012 10.5"
          fill="#CBD5E1"
          opacity="0.7"
        />
      </svg>
  ...
  if (code === "150")
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        ...
        <circle cx="34" cy="14" r="1" fill="#C4B5FD" />
        <circle cx="38" cy="20" r="0.8" fill="#C4B5FD" />
        <circle cx="30" cy="8" r="0.6" fill="#C4B5FD" />
      </svg>
    );
  // Night cloudy
  if (["151", "153"].includes(code))
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        <path
          d="M28 10a10 10 0 100 18 7 7 0 010-18z"
          fill="#818CF8"
          opacity="0.6"
        />
        <path
          d="M14 36a7 7 0 01-1.5-13.8A9 9 0 0130 25a6 6 0 011.5 11"
          fill="#94A3B8"
        />
      </svg>
    );
  // Light rain
  if (["300", "301", "305", "306", "309", "399"].includes(code))
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        <path
          d="M12 26a8 8 0 01-2-15.8A10 10 0 0129.5 14 7 7 0 0132 26H12z"
          fill="#94A3B8"
        />
        <g stroke="#60A5FA" strokeWidth="2" strokeLinecap="round">
          <line x1="16" y1="30" x2="14" y2="36" />
          <line x1="24" y1="30" x2="22" y2="36" />
          <line x1="32" y1="30" x2="30" y2="36" />
        </g>
      </svg>
    );
  // Heavy rain
  if (["307", "308", "310", "311", "312", "313"].includes(code))
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        <path
          d="M12 24a8 8 0 01-2-15.8A10 10 0 0129.5 12 7 7 0 0132 24H12z"
          fill="#64748B"
        />
        <g stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round">
          <line x1="14" y1="28" x2="11" y2="36" />
          <line x1="22" y1="28" x2="19" y2="36" />
          <line x1="30" y1="28" x2="27" y2="36" />
  ...
  if (["302", "303", "304"].includes(code))
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        <path
          d="M12 22a8 8 0 01-2-15.8A10 10 0 0129.5 10 7 7 0 0132 22H12z"
          fill="#475569"
        />
    ...
    return (
      <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
        <g stroke="#60A5FA" strokeWidth="2" strokeLinecap="round">
          ...
          <line x1="14" y1="12" x2="24" y2="18" />
          <line x1="34" y1="12" x2="24" y2="18" />
          <line x1="14" y1="36" x2="24" y2="30" />
          <line x1="34" y1="36" x2="24" y2="30" />
          <line x1="10" y1="24" x2="16" y2="24" />
          <line x1="38" y1="24" x2="32" y2="24" />
        </g>
  ...
  return (
    <svg width={s} height={s} viewBox="0 0 48 48" fill="none">
      ...
      <path
        d="M16 34a7 7 0 01-1.5-13.8A9 9 0 0133 23a6 6 0 011 11H16z"
        fill="#CBD5E1"
      />
    </svg>
  );
...
const IndexIcon: Record<string, React.ReactNode> = {
  clothing: (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M6.5 2L2 6.5l3.5 3.5L8 8l2 10h4L16 8l2.5 2L22 6.5 17.5 2l-3 3a2 2 0 01-3 0l-3-3z" />
    </svg>
  ),
  uv: (
    <svg
  ...
  exercise: (
    ...
    >
      ...
      <path d="M10 22V18l-2-3 4-5 2 3h3l1 4v3" />
    </svg>
  ),
  cold_risk: (
    <svg
      ...
      strokeLinecap="round"
    >
      <path d="M12 2a5 5 0 00-5 5c0 3.5 5 9 5 9s5-5.5 5-9a5 5 0 00-5-5z" />
  ...
  travel: (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M17.8 19.2L16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5 7.5 5.6-3.1 3.1-2.5-.8-1.7 1.4 3.5 2.6 2.6 3.5 1.4-1.7-.8-2.5 3.1-3.1 5.6 7.5.5-.3c.4-.2.6-.6.5-1.1z" />
    </svg>
  ),
  mood: (
    <svg
            ...
            <div className="flex-1 overflow-auto">
              <div className="text-center mb-3">
                ...
                <div className="flex justify-center my-1">
                  <WeatherIcon code={data.weather_icon} size={48} />
                </div>
              ...
              {data.aqi !== undefined && (
                <div
                  className={`${getAqiBg(data.aqi_level)} rounded-lg p-2 mb-2`}
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-xs font-black ${getAqiColor(data.aqi_level)}`}
                    >
                  ...
                  {data.air_pollutants && (
                    <div className="grid grid-cols-3 gap-1 mt-1.5">
                      {[
                        {
                          label: "PM2.5",
                          value: data.air_pollutants.pm25,
                          unit: "μg/m³",
                        },
                        {
                          label: "PM10",
                          value: data.air_pollutants.pm10,
                          unit: "μg/m³",
                        },
                        {
                          label: "O₃",
                          value: data.air_pollutants.o3,
                          unit: "μg/m³",
                        },
                        {
                          label: "NO₂",
                          value: data.air_pollutants.no2,
                          unit: "μg/m³",
                        },
                        {
                          label: "SO₂",
                          value: data.air_pollutants.so2,
                          unit: "μg/m³",
                        },
                        {
                          label: "CO",
                          value: data.air_pollutants.co,
                          unit: "mg/m³",
                        },
                      ].map((p) => (
                ...
                <div>
                  ...
                  <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1">
                    {data.hourly_forecast.slice(0, 12).map((h, i) => (
                      <div
                        key={i}
                        className="flex flex-col items-center gap-0.5 shrink-0 w-10"
                      >
                        <span className="text-[9px] text-slate-400">
                          {i === 0 ? "现在" : formatHour(h.time)}
                        </span>
                ...
                return (
                  ...
                  >
                    <div className="w-10 shrink-0">
                      <div
                        className={`text-xs font-bold ${isToday ? "text-indigo-500" : "text-slate-700 dark:text-slate-300"}`}
                      >
                    ...
                    <div className="shrink-0">
                      <WeatherIcon code={String(day.weather_day)} size={24} />
                    </div>
                    <div className="flex-1 flex items-center gap-1">
                      <span className="text-[10px] text-blue-400 w-6 text-right">
                      ...
                      <span className="text-[10px] text-orange-400 w-6">
                        {Math.round(day.temp_max)}°
                      </span>
                    </div>
                    <div className="text-[9px] text-slate-400 shrink-0 w-12 text-right">
                      {day.weather_day}
                    </div>
                  </div>
                );
              ...
              <div className="grid grid-cols-2 gap-1.5">
                {indexKeys.map((key) => {
                  ...
                  return (
                    <div
                      key={key}
                      className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-2"
                    >
