            ...
            <svg viewBox="0 0 100 100" className="w-full h-full">
              ...
              <line
                ...
                x2={
                  ...
                  20 *
                    Math.sin(
                      ((h % 12) * 30 * Math.PI) / 180 + (m * Math.PI) / 360,
                    )
                }
                y2={
                  50 -
              ...
              <line
                x1="50"
                y1="50"
                x2={50 + 28 * Math.sin((m * 6 * Math.PI) / 180)}
                y2={50 - 28 * Math.cos((m * 6 * Math.PI) / 180)}
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
              ...
              <line
                x1="50"
                y1="50"
                x2={50 + 32 * Math.sin((s * 6 * Math.PI) / 180)}
                y2={50 - 32 * Math.cos((s * 6 * Math.PI) / 180)}
                stroke="currentColor"
                strokeWidth="0.8"
                strokeLinecap="round"
          ...
          {laps.length > 0 && (
            <div className="flex-1 overflow-auto">
              {laps.map((lap, i) => (
                <div
                  key={i}
                  className="flex justify-between text-xs py-1 px-2 border-b border-slate-100 dark:border-slate-800"
                >
