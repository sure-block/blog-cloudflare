...
const BASE_ICONS: Record<number, React.ReactNode> = {
  ...
  10: (
    ...
    >
      ...
      <path d="M9 4l4 2v12" strokeLinecap="round" strokeLinejoin="round" />
  ...
  16: (
    <svg
      ...
      strokeWidth="1.5"
    >
      <path d="M4 7l4-3v16" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 7l4-3v16" strokeLinecap="round" strokeLinejoin="round" />
  ...
  const commonValues = useMemo(() => {
    ...
    try {
      ...
      return {
        ...
        signed8:
          decimal < 256
            ? (decimal > 127 ? decimal - 256 : decimal).toString()
            : null,
      };
    } catch {
      return null;
  ...
  return (
    <div className="flex flex-col h-full gap-3">
      ...
      <div className="space-y-2">
        ...
        {error && (
          <p className="text-[10px] text-rose-500 font-medium px-1">{error}</p>
        )}
      </div>
