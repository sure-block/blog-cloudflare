    ...
    <div className="flex flex-col items-center gap-2 md:gap-3 w-full select-none py-2">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <div
                        className={`absolute bg-slate-400 dark:bg-slate-600 ${isEdge ? "w-[calc(100%-12px)] h-px" : "w-full h-px"}`}
                      />
                      <div
                        className={`absolute bg-slate-400 dark:bg-slate-600 ${isEdge ? "h-[calc(100%-12px)] w-px" : "h-full w-px"}`}
                      />
                    </div>
                    {/* Star points */}
                    {(r === 3 || r === 7 || r === 11) &&
      ...
      {!winner && (
        <div className="flex items-center gap-2 text-xs">
          <div
            className={`w-3 h-3 rounded-full ${turn === "black" ? "bg-slate-900 dark:bg-white" : "bg-white border-2 border-slate-400"}`}
          />
