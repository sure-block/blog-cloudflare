...
const fortunes: Fortune[] = [
  {
    ...
    poem: "龙飞凤舞庆升平，万事亨通福自生。",
    advice: "所求皆遂，百事大吉。",
    desc: "此签大吉，诸事皆宜，正是鸿运当头之时。",
  },
  {
    level: "上上签",
    levelColor: "text-red-500",
    ...
    advice: "把握时机，乘风破浪。",
    desc: "运势极佳，无论事业还是感情，都将迎来美好的转折。",
  },
  {
    level: "上上签",
    levelColor: "text-red-500",
    poem: "紫气东来照四方，吉星高照保安康。",
    advice: "贵人相助，逢凶化吉。",
    desc: "福星高照，贵人运旺盛，凡事皆有贵人相助。",
  },
  {
    level: "上签",
    levelColor: "text-orange-500",
    poem: "云开月明正当时，柳暗花明又一村。",
    advice: "坚持到底，终见曙光。",
    desc: "虽然眼前有些困难，但转机就在前方。",
  },
  {
    level: "上签",
    levelColor: "text-orange-500",
    poem: "春来草木皆生意，丰年禾黍尽登场。",
    advice: "顺势而为，水到渠成。",
    desc: "时运正佳，适合开展新计划，一切将顺风顺水。",
  },
  {
    level: "上签",
    levelColor: "text-orange-500",
    poem: "千里姻缘一线牵，有情人终成眷属。",
    advice: "缘分天定，珍惜眼前。",
    desc: "桃花运旺盛，感情方面将有好消息传来。",
  },
  {
    level: "中签",
  ...
  },
  {
    ...
    poem: "行到水穷处，坐看云起时。",
    advice: "以退为进，韬光养晦。",
    desc: "暂时的停顿是为了更好的出发，不必焦虑。",
  },
  {
    level: "中签",
    levelColor: "text-amber-500",
    poem: "一壶浊酒喜相逢，古今多少事，都付笑谈中。",
    advice: "看淡得失，随遇而安。",
    desc: "人生如戏，不必太执着于眼前的得失。",
  },
  {
    level: "下签",
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-4">
        ...
        >
          <svg viewBox="0 0 120 160" className="w-24 h-32">
            {/* 签筒 */}
            <path
              d="M30 50 L20 150 Q20 155 25 155 L95 155 Q100 155 100 150 L90 50 Z"
              fill="#8b5cf6"
              opacity="0.15"
              stroke="#8b5cf6"
              strokeWidth="2"
            ...
            <rect
              ...
              fill="#f59e0b"
              opacity="0.8"
              transform={`rotate(${-8 + shakeAngle * 0.3}, 48, 100)`}
            />
            <rect
              x="55"
              y="25"
              ...
              fill="#f59e0b"
              opacity="0.6"
              transform={`rotate(${5 + shakeAngle * 0.2}, 58, 100)`}
            />
            <rect
              x="65"
              y="18"
              ...
              fill="#f59e0b"
              opacity="0.7"
              transform={`rotate(${12 + shakeAngle * 0.4}, 68, 100)`}
            />
            {/* 签筒装饰 */}
            <rect
              x="25"
        ...
        {state === "shaking" && (
          <p className="text-sm text-indigo-500 font-bold animate-pulse">
            摇签中...
          </p>
        )}
        ...
        {state === "drawn" && current && (
          <div className="w-full bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 text-center">
            <div className={`text-lg font-black mb-2 ${current.levelColor}`}>
              {current.level}
            </div>
            <p className="text-sm text-slate-800 dark:text-slate-200 font-medium leading-relaxed mb-2">
              「{current.poem}」
            </p>
            <div className="text-xs text-indigo-500 dark:text-indigo-400 font-bold mb-1">
              {current.advice}
            </div>
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 pt-2">
          <div className="flex justify-between text-[10px]">
            {["上上签", "上签", "中签", "下签", "下下签"].map((level) => {
              ...
              const color =
                fortunes.find((f) => f.level === level)?.levelColor ||
                "text-slate-400";
              return (
