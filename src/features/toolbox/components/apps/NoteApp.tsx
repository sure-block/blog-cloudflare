      ...
      <div className="flex-1 overflow-y-auto space-y-2 pr-1">
        {notes.length === 0 ? (
          ...
          notes.map((note) => (
            <div
              key={note.id}
              className={`group rounded-xl border p-3 transition-all duration-200 hover:shadow-md ${note.color}`}
            >
              {editingId === note.id ? (
                <div className="space-y-2">
                  ...
                  <div className="flex gap-1 justify-end">
                    <button
                      ...
                      title="取消"
                      className="px-2 py-0.5 text-xs rounded-lg text-slate-500 hover:bg-white/50 dark:hover:bg-slate-700/50 transition-colors"
                    >
                      取消
                    </button>
                    <button
                      ...
                      onClick={saveEdit}
                      title="保存"
                      className="px-2 py-0.5 text-xs rounded-lg bg-indigo-500 text-white hover:bg-indigo-600 transition-colors"
                    >
                      保存
                    </button>
                  </div>
